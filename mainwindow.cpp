...
//  if(tmc_write("*IDN?;:SYST:ERR?") != 16)  // This is a fix for the broken *IDN? command in older fw version
  ...
  if(devparms.k_cfg != nullptr)
  {
    free(devparms.k_cfg);
  }
  devparms.k_cfg = kiss_fftr_alloc(devparms.fftbufsz * 2, 0, nullptr, nullptr);
...
void UI_Mainwindow::close_connection()
{
  ...
  scrn_thread->set_device(nullptr);
...
void UI_Mainwindow::zoom_in()
{
  ...
  if(devparms.timebasedelayenable)
  {
    ...
    devparms.timebasedelayscale = round_down_step125(devparms.timebasedelayscale, nullptr);
  ...
  else
  {
    ...
    devparms.timebasescale = round_down_step125(devparms.timebasescale, nullptr);
...
void UI_Mainwindow::zoom_out()
{
  ...
  if(devparms.timebasedelayenable)
  {
    ...
    devparms.timebasedelayscale = round_up_step125(devparms.timebasedelayscale, nullptr);
  ...
  else
  {
    ...
    devparms.timebasescale = round_up_step125(devparms.timebasescale, nullptr);
...
void UI_Mainwindow::chan_scale_plus()
{
  ...
  if(devparms.math_fft && devparms.math_fft_split)
  {
    devparms.fft_vscale = round_up_step125(devparms.fft_vscale, nullptr);
  ...
  val = round_up_step125(devparms.chanscale[chn], nullptr);
...
void UI_Mainwindow::chan_scale_minus()
{
  ...
  if(devparms.math_fft && devparms.math_fft_split)
  {
    devparms.fft_vscale = round_down_step125(devparms.fft_vscale, nullptr);
  ...
  {
    val = round_down_step125(devparms.chanscale[chn], nullptr);
  }
...
void UI_Mainwindow::set_cue_cmd(const char *str)
{
  ...
  devparms.cmd_cue_resp[devparms.cmd_cue_idx_in] = nullptr;
